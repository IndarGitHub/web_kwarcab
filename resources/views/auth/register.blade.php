...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-kwarcab2.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                {!! csrf_field() !!}
					...
					<div class="wrap-input100 validate-input m-b-23 has-feedback{{ $errors->has('name') ? ' has-error' : '' }}" data-validate = "Silahkan Masukkan Nama">
						<span class="label-input100">Nama</span>
						<input class="input100" type="text" name="name" value="{{ old('name') }}" placeholder="Nama Lengkap">
					...
					<div class="wrap-input100 validate-input has-feedback{{ $errors->has('password_confirmation') ? ' has-error' : '' }}" data-validate="Silahkan Masukkan Ulang Password">
