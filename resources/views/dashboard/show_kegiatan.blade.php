...
<head>
    ...
    <title>{{ $kegiatan->judul_kegiatan }}</title>
    <style>
    body{
    background: #fff;
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card" style="margin-bottom:35px;margin-top:35px">
                <h5 class="card-header" style="background-color:#07ab2d;color: #fff;">{{ $kegiatan->judul_kegiatan }}</h5>
                <div class="card-body">
                    ...
                    <p class="card-text">{{ $kegiatan->isi_kegiatan }}</p>
                    ...
                    @auth
                    <form action="{{url('kegiatan/comment/'.$kegiatan->id) }}" method="patch">
            ...
            <div style="margin-bottom:35px;margin-top:35px;">
                ...
                <div class="media">
                    ...
                    <div class="media-body" style="margin:2%">
                        <p class="mt-0" style="color:#000;">{{$berita->judul}}</p>
                        <p><small class="text-muted">{{$berita->created_at->diffForHumans()}}</small></p>
                    </div>
                </div>
                </a>
                <hr>
